...
class CreateBoardScreenTest() : BaseTest() {
...
//        .around(clearFilesRule)
    ...
    fun createBoardAndVerifyIt() {
        ...
        mainScreen {
            checkFakeBoardWasCreate()
        }
    }

    @Test
    fun checkErrorSameBoardNameAppear() {
        splashScreen {
            signIn()
            waitForSplashScreenIsGone()
            checkIsUserIsLoggedIn()
    ...
    @Test
    fun checkErrorBlankBoardNameAppear() {
        splashScreen {
            signIn()
            waitForSplashScreenIsGone()
            checkIsUserIsLoggedIn()
