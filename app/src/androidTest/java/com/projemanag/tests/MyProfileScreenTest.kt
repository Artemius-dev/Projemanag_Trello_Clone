...
import com.projemanag.robots.profileScreen
...
class MyProfileScreenTest() : BaseTest() {
...
//        .around(clearFilesRule)
    ...
    @Test
    fun checkIsNameAndEmailVisible() {
        splashScreen {
            signIn()
    ...
    fun updateNameAndCheckIt() {
        ...
        mainScreen {
            tapOnOpenMenuButton()
            tapOnOpenProfile()
            checkMyProfileActivityShowAgain()
        }
        profileScreen {
            verifyUpdateName()
        }
